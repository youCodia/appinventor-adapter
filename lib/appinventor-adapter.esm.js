...
function _parseData() {
  ...
  regeneratorRuntime.mark(function _callee(strData, json) {
    var str, numOfItems, result, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, n, key, importClass, model, Model;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 42:
            ...
            _context.next = 45;
            return import("../models/".concat(importClass));
...
//# sourceMappingURL=appinventor-adapter.esm.js.map
